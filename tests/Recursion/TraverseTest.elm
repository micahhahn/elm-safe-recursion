...
sequenceListMap f =
    runRecursion <|
        \(ListNode val list) ->
            sequenceList list (ListNode (f val) >> base)
...
traverseListMap f =
    runRecursion <|
        \(ListNode val list) ->
            traverseList recurse list (ListNode (f val) >> base)
...
sequenceDictMap f =
    runRecursion <|
        \(DictNode val dict) ->
            sequenceDict dict (DictNode (f val) >> base)
...
traverseDictMap f =
    runRecursion <|
        \(DictNode val dict) ->
            traverseDict (\_ v -> recurse v) dict (DictNode (f val) >> base)
...
sequenceArrayMap f =
    runRecursion <|
        \(ArrayNode val array) ->
            sequenceArray array (ArrayNode (f val) >> base)
...
traverseArrayMap f =
    runRecursion <|
        \(ArrayNode val array) ->
            traverseArray recurse array (ArrayNode (f val) >> base)
...
sequenceMaybeMap f =
    runRecursion <|
        \(MaybeNode val array) ->
            sequenceMaybe array (MaybeNode (f val) >> base)
...
traverseMaybeMap f =
    runRecursion <|
        \(MaybeNode val array) ->
            traverseMaybe recurse array (MaybeNode (f val) >> base)
...
sequenceResultMap f =
    runRecursion <|
        \(ResultNode val array) ->
            sequenceResult array (ResultNode (f val) >> base)
...
traverseResultMap f =
    runRecursion <|
        \(ResultNode val array) ->
            traverseResult recurse array (ResultNode (f val) >> base)
